...
INSERT INTO tickets_schema.users_of_ticket (id, username, first_name, last_name, department_id, status)
VALUES ('2e18a2f4-a49d-11ed-ad47-0242ac120002', 'j.joyce@mail.ru', 'James', 'Joyce', '1', 'ACTIVE'),
       ('34f3d3f0-a49d-11ed-ad47-0242ac120002', 'm.proust@mail.ru', 'Marcel', 'Proust', '2', 'NOT_ACTIVE'),
       ('394e0a24-a49d-11ed-ad47-0242ac120002', 'l.celine@mail.ru', 'Louis', 'Céline', '3', 'DELETED');
...
VALUES ('a6efd5d0-a49d-11ed-ad47-0242ac120002', 'Make some some streams of consciousness', 'Write an article about them',
        ...
        '3', current_timestamp, '2023-02-10', 'false');
