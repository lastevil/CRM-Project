...
public class UpdatedUserValidator {
    ...
    public void validate(UpdatedUserDto updatedUserDto) {
        ...
        if (updatedUserDto.getFirstName().isBlank()) errors.add("First name must not be blank");
        if (updatedUserDto.getLastName().isBlank()) errors.add("Last name must not be blank");
        if (updatedUserDto.getPassword().isBlank()) errors.add("Password must not be blank");
        if (updatedUserDto.getEmail().isBlank()) errors.add("Email must not be blank");
